...
<html>
<head>
<title> Online Shopping Mall | Services</title>
		...
		<div class="container">
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com">admin@gmail.com</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- //header -->
<!-- products-breadcrumb -->
	<div class="products-breadcrumb" style="background-color: #F7660C";>
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="../index.php">Home</a><span style="color:#fff;">|</span></li>
				<li style="color:#00244a;">Events</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
