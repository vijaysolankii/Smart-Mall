...
<html>
<head>
<title> Online Shopping Mall | About</title>
...
<!-- header -->
	<div class="agileits_header">
		...
		<div div class="product_list_header" style="background:  rgb(247, 102, 12);">  
		...
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="../index.php">Home</a>
				 <span style="color:#fff;">|</span></li>
				<li style="color:#00244a;">About Us</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
